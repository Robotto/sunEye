...
mogrify -crop 580X580+95+75 +repage -rotate "90" -resize 240x240 -fill white -stroke white -strokewidth 1 -draw "line 160,0 160,240" -draw "line 0,213 239,213" -draw "fill none circle 122,122 160,213" -draw "fill red circle 121.5,121.5 122.5,122.5" -stroke $kpColour -fill $kpColour -strokewidth 1 -pointsize 25 -annotate +10+30 "kp: $KP" ovation.jpg
